...
public class FenleiMyGridView extends GridView {

	public FenleiMyGridView(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	protected void dispatchDraw(Canvas canvas) {
		...
		localPaint.setColor(getContext().getResources().getColor(R.color.graywhite));
